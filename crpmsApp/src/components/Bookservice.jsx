...
function Bookservice() {
    ...
    return (
        <><Header />
            <div className="min-h-screen bg-[url('car1.jpg')] bg-cover bg-center flex flex-col items-center justify-center text-center px-4  text-white">
                ...
                <div className="grid grid-cols-1 rounded-full bg-gray-900/70  w-full mb-8 text-center">

                    <div className="bg-gray-900/70 p-1 rounded shadow">
                    ...
                    <div className="bg-gray-900/70p-1 rounded shadow">
